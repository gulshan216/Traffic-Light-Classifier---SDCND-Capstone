...
def main(_):
    ...
    INPUT_YAML = "/media/gulshan/913b4460-8150-4358-aa66-ee5fb03e6f50/Tensorflow_Object_Detection/TrafficLight_Detection-TensorFlowAPI/colored_labelled_dataset/labeled_dataset.yaml"
